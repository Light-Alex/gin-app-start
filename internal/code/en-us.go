...
var enUSText = map[int]string{
	...
	MarshalError:       "JSON serialization failed",
	UnmarshalError:     "JSON deserialization failed",
	FormFileError:      "Form file parameter error",
	FileUploadError:    "File upload failed",
	ParamQueryError:    "Parameter query error",
